...
STRIP_ID = ["1447792070", "1447792070"]

# for print :
usr = "STRIP USERBOT -{}".format(Tlk)
adn = "STRIP ADMIN TOOLS -{}".format(Tlk)
ani = "STRIP ANIMATIONS -{}".format(Tlk)
tsh = "STRIP TOSHA -{}".format(Tlk)
ast = "STRIP ASSISTANT -{}".format(Tlk)
pmt = "STRIP ASSISTANT PM -{}".format(Tlk)
