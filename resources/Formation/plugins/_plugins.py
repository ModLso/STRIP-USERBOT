...
R = (
    ...
    "- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ⪼ [𝘾𝙇𝙄𝘾𝙆 𝙃𝙀𝙍𝙀](t.me/ModLso) ⩫ \n"
    "- 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 ⪼ [𝘾𝙇𝙄𝘾𝙆 𝙃𝙀𝙍𝙀](https://github.com/ModLso/STRIP-USERBOT) ⩫"
)
K = "https://github.com/ModLso/STRIP-USERBOT"

# Alive Bot 
TOSH = (
       f"**⌔∮ بوت سترايب يعمل بنجاح 🖤❕**\n"
