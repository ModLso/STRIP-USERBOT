...
Message = (
"""       ⫷ بوت سترايب يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
⫷ @ModLso - اذا كنت بحاجه الى مساعده فتوجه الى ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين سترايب ⫸',
    '⫷ اكتمل تنزيل انلاين سترايب بدون اخطاء ⫸',
    '⫷ يتم بدء بوت سترايب ⫸',
    '⫷ اكتمل بدء بوت سترايب ⫸'
]
