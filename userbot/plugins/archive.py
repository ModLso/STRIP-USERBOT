...
@icssbot.on(admin_cmd(pattern=("zip ?(.*)")))
@icssbot.on(sudo_cmd(pattern="zip ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(sudo_cmd(pattern="unzip ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern=("rar ?(.*)")))
@icssbot.on(sudo_cmd(pattern="rar ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(sudo_cmd(pattern="tar ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern="unrar"))
@icssbot.on(sudo_cmd(pattern="unrar", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await edit_or_reply(event, "Processing ...")
...
@icssbot.on(admin_cmd(pattern="untar"))
@icssbot.on(sudo_cmd(pattern="untar", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await edit_or_reply(event, "Processing ...")
