# commands for source icss by ~ @ModLso
...
@Stripbot.on(icss_cmd(outgoing=True, pattern="المطور$"))
@Stripbot.on(sudo_cmd(pattern="المطور$", allow_sudo=True))
async def _(e):
    if e.fwd_from:
        return
    ...
    if DEV_IMG:
        ...
        dev_c += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 ↬ @ModLso ༗\n"
        dev_c += f"**{EMOJI}** 𝑫𝑬𝑽 𝑰𝑫 ↬ 1447792070 ༗\n"
        dev_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐢𝐜𝐬𝐬ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
